/*
  MqttBeebotteCom_pem.h

  https://beebotte.com/docs/mqtt

  | Beebotte MQTT is accessible on mqtt.beebotte.com and
  | accepts cleartext (port 1883) and secure (port 8883) connections.
  | 
  | mqtt.beebotte.com, Port 1883, no SSL
  | mqtt.beebotte.com, Port 8883, with SSL
  | 
  | To connect to Beebotte MQTT with SSL/TLS, you might need to
  | download the server certificate.
  |   => https://beebotte.com/certs/mqtt.beebotte.com.pem
 */

#ifndef MQTTBEEBOTTECOM_PEM_H
#define MQTTBEEBOTTECOM_PEM_H

const char *certMqttBeebotteCom = \
"-----BEGIN CERTIFICATE-----\n" \
